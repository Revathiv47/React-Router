        ...
        <div>
            ...
            <div className="row">
                ...
                <div className="col-lg-6">
                    ...
                    <input type="text" name="email" value={startdate} onChange={(e) => setStartDate(e.target.value)} className="form-control" />
                </div>
                <div className="col-lg-6">
                    <label>Salary</label>
            ...
            <div className="row mt-3">
                <div className="col-lg-12">
                    <input  type="submit" valur="Submit" className="btn btn-primary"  />
                </div>
            </div>
            </form>
                </div>
